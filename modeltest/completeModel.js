...
db.exercise.insert(
    {
        ...
        "<p> I would  like you to compare the photographs, and say how important it is to help people in these situations.</p>." +
        "<p> (candidate B) do you find easy to ask for help when you have a problem? (Why / Why not? )</p>" +
        "<p> Now, (candidate B), here are your photographs. they show people spending time in different gardens </p>" +
